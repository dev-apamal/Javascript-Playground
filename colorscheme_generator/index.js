...
getColorSchemeButton.addEventListener('click', function(e){
    ...
    While we could directly use inputColor.value and avoid all hastle to display the color, 
    I am making an API request here just to learn/practice how API requests work.*/
